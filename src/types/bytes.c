...
static const struct type_method_t bytes_cb_methods[] = {
        ...
        {"decode",       do_bytes_decode},
        {"endswith",     do_bytes_endswith},
        {"expandtabs",   do_bytes_expandtabs},
        {"find",         do_bytes_find},
        {"index",        do_bytes_index},
        {"isalnum",      do_bytes_isalnum},
        {"isalpha",      do_bytes_isalpha},
        {"isascii",      do_bytes_isascii},
        {"isdigit",      do_bytes_isdigit},
        {"islower",      do_bytes_islower},
        {"isspace",      do_bytes_isspace},
        {"istitle",      do_bytes_istitle},
        {"isupper",      do_bytes_isupper},
        {"join",         do_bytes_join},
        {"ljust",        do_bytes_ljust},
        {"lower",        do_bytes_lower},
        {"lstrip",       do_bytes_lstrip},
        {"partition",    do_bytes_partition},
        {"removeprefix", do_bytes_removeprefix},
        {"removesuffix", do_bytes_removesuffix},
        {"replace",      do_bytes_replace},
        {"rfind",        do_bytes_rfind},
        {"rindex",       do_bytes_rindex},
        {"rjust",        do_bytes_rjust},
        {"rpartition",   do_bytes_rpartition},
        {"rsplit",       do_bytes_rsplit},
        {"rstrip",       do_bytes_rstrip},
        {"split",        do_bytes_split},
        {"splitlines",   do_bytes_splitlines},
        {"startswith",   do_bytes_startswith},
        {"strip",        do_bytes_strip},
        {"swapcase",     do_bytes_swapcase},
        {"title",        do_bytes_title},
        {"upper",        do_bytes_upper},
        {"zfill",        do_bytes_zfill},
        {NULL, NULL},
};
